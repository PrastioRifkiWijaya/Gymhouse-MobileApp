...
import 'package:gymhouse_project/Components/WorkoutRoutine/menengah/situpsilang.dart';
...
class crunchsepeda extends StatefulWidget {
  const crunchsepeda({Key? key}) : super(key: key);

  @override
  State<crunchsepeda> createState() => _crunchsepedaState();
}
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        situpsilang(), // Ganti NextPage() dengan halaman tujuan navigasi
                  ),
                );
              },
            ),
