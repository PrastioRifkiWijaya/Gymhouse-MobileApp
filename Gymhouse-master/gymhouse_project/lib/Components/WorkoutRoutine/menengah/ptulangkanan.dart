...
class ptulangkanan extends StatefulWidget {
  @override
  _ptulangkananState createState() => _ptulangkananState();
}

class _ptulangkananState extends State<ptulangkanan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Peregangan Tulang Kanan',
