...
import 'package:gymhouse_project/Components/WorkoutRoutine/menengah/Crunchsepeda.dart';
...
class sentuhtumit extends StatefulWidget {
  const sentuhtumit({Key? key}) : super(key: key);

  @override
  State<sentuhtumit> createState() => _sentuhtumitState();
}
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Image.asset('assets/images/Asset 16gym.png', height: 300, width: 350),
              //  SvgPicture.asset(
            ...
            ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        crunchsepeda(), // Ganti NextPage() dengan halaman tujuan navigasi
                  ),
                );
              },
            ),
