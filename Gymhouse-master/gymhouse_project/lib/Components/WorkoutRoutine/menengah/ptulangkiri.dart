...
import 'package:gymhouse_project/Components/WorkoutRoutine/menengah/ptulangkanan.dart';
import 'package:gymhouse_project/Components/WorkoutRoutine/pemula/wallsitpemula.dart';
import 'package:gymhouse_project/utils/constant.dart';

class ptulangkiri extends StatefulWidget {
  @override
  _ptulangkiriState createState() => _ptulangkiriState();
}

class _ptulangkiriState extends State<ptulangkiri> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Peregangan Tulang Kiri',
              ...
              child: Text('FINISH', style: mEditProfile,),
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          ptulangkanan(), // Ganti NextPage() dengan halaman tujuan navigasi
                    ),
                  );
                },
              ),
