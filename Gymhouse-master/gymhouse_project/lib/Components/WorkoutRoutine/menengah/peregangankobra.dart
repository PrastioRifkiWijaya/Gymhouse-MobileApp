...
import 'package:gymhouse_project/Components/WorkoutRoutine/menengah/ptulangkiri.dart';
              ...
              child: Text('FINISH', style: mEditProfile,),
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          ptulangkiri(), // Ganti NextPage() dengan halaman tujuan navigasi
                    ),
                  );
                },
              ),
