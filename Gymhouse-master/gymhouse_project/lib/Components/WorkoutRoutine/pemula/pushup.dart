...
class Pushuppemula extends StatefulWidget {
  const Pushuppemula({Key? key}) : super(key: key);

  @override
  State<Pushuppemula> createState() => _PushuppemulaState();
}

class _PushuppemulaState extends State<Pushuppemula> {
  @override
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      Situppemula(), // Ganti NextPage() dengan halaman tujuan navigasi
                ),
              );
            },
          ),
