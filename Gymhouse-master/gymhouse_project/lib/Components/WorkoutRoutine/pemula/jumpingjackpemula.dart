...
class jumpingjackpemula extends StatefulWidget {
  const jumpingjackpemula({Key? key}) : super(key: key);

  @override
  State<jumpingjackpemula> createState() => _jumpingjackpemulaState();
}

class _jumpingjackpemulaState extends State<jumpingjackpemula> {
  @override
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      selesaipemula(), // Ganti NextPage() dengan halaman tujuan navigasi
                ),
              );
            },
          ),
