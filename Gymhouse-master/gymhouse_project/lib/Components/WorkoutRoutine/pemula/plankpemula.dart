...
class plankpemula extends StatefulWidget {
  @override
  _plankpemulaState createState() => _plankpemulaState();
}

class _plankpemulaState extends State<plankpemula> {
              ...
              child: Text('FINISH', style: mEditProfile,),
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          wallsitpemula(), // Ganti NextPage() dengan halaman tujuan navigasi
                    ),
                  );
                },
              ),
