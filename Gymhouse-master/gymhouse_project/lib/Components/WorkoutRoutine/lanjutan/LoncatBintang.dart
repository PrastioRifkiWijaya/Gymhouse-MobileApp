...
import 'package:gymhouse_project/Components/WorkoutRoutine/lanjutan/pbahu.dart';
...
class loncatbintang extends StatefulWidget {
  @override
  _loncatbintangState createState() => _loncatbintangState();
}

class _loncatbintangState extends State<loncatbintang> {
              ...
              child: Text('FINISH', style: mEditProfile,),
                onPressed: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          pbahu(), // Ganti NextPage() dengan halaman tujuan navigasi
                    ),
                  );
                },
              ),
